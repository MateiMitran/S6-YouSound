...
public class KeyUtils {
    ...
    @Value("access-refresh-token-keys/access-token-private.key")
    private String accessTokenPrivateKeyPath;

    @Value("access-refresh-token-keys/access-token-public.key")
    private String accessTokenPublicKeyPath;

    @Value("access-refresh-token-keys/refresh-token-private.key")
    private String refreshTokenPrivateKeyPath;

    @Value("access-refresh-token-keys/refresh-token-public.key")
