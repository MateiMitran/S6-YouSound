...
set JARPATH=%APP_HOME%\lib\security-service-1.0-SNAPSHOT.jar

@rem Execute security-service
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SECURITY_SERVICE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%SECURITY_SERVICE_EXIT_CONSOLE%" exit 1
exit /b 1
